<?php 
    ...
    $dcb = mysqli_connect( //Use esta variável para realizar outras ações no banco de dados.
        'data.aliensabductedme.com', //Localização do banco de dados. 
        'owen', //Nome de usuário
        'aliensrool', //Senha
